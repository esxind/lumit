!function() {
    ...
    class n {
        ...
        runOnResize(e, n) {
            ...
            n.runOnLoad && function(e, n=Number.MAX_VALUE) {
                var o;
    ...
    const r = !(!a || (s = a,
    !s.match(/AppleWebKit\//) || s.match(/Chrome\//) || s.match(/Chromium\//)));
    var s;
    !function() {
        ...
        e.forEach((e=>{
            ...
            const o = {}
              , {maybeResetVideoProgress: i, videoStart: a} = function(e, t) {
                const n = e.dataset.trimStartUs
                  , o = e.dataset.trimEndUs
                  , i = null != n ? parseFloat(n) / 1e6 : 0;
                let a = null != o ? parseFloat(o) / 1e6 : void 0;
                e.currentTime = i,
                e.loop && i > 0 && (e.dataset.loop = "true",
                e.loop = !1);
                e.addEventListener("timeupdate", (()=>{
                    const t = e.currentTime;
                    let n;
                    null != a && t >= a - (r ? .25 : 0) ? e.loop || e.dataset.loop ? (n = i,
                    e.play()) : e.pause() : t < i && (n = i),
                    null != n && t !== n && (e.currentTime = n)
                }
                ));
                const s = ()=>{
                    var n;
                    isNaN(e.duration) || (null == a && (a = e.duration),
                    null === (n = t.updateDuration) || void 0 === n || n.call(t, i, a))
                }
                ;
            ...
            e.autoplay ? (e.autoplay = !1,
            e.paused || e.pause(),
            n.observe(e)) : function(e, t) {
            ...
            const s = function(e, t, n, o) {
                ...
                d.style.top = e.getAttribute("data-controls-top") || "0%",
                d.style.left = e.getAttribute("data-controls-left") || "0%",
                d.style.width = e.getAttribute("data-controls-width") || "100%",
                d.style.height = e.getAttribute("data-controls-height") || "100%",
                e.controls = !1;
                const {seekBar: l, updateDuration: c} = function(e) {
                ...
                const {playButton: u, playPause: p} = function(e, t) {
                    let n = !1;
                ...
                e.paused ? g() : m();
                const y = ()=>{
                    e.paused || (u.style.opacity = "1"),
                    l.style.opacity = "1"
                }
                  , b = ()=>{
                    e.paused || (u.style.opacity = "0"),
                    l.style.opacity = "0"
                }
                ;
                d.addEventListener("mouseenter", y),
                d.addEventListener("mouseover", y),
                d.addEventListener("mousemove", y),
                d.addEventListener("mouseleave", b),
                ...
                return {
                    onResizeCallback: ()=>{
                        ...
                        u.style.visibility = e ? "visible" : "hidden",
                        l.style.visibility = t ? "visible" : "hidden"
                    }
                    ,
                    videoStart: n
                }
            ...
            !function(e) {
                ...
                if (r)
                    for (const t of o) {
                        if (parseFloat(t.width.replace("w", "")) >= r)
